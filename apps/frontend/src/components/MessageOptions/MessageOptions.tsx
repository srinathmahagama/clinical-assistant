...
const MessageOptions: React.FC<MessageOptionsProps> = ({ onDelete, isUser }) => {
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      {/* Dropdown menu */}
      {isOpen && (
        <div className={`absolute right-0 top-8 z-50 min-w-[120px] rounded-lg shadow-lg border transition-colors duration-300 ${
          theme === 'dark' 
